...
public class GameOffline extends AppCompatActivity implements View.OnClickListener {
        ...
        if (((Button) v).getText()
            ...
            if (checkWinner()) {
                if (activePlayer) {
                    ...
                    Toast.makeText(this, player2.getUsername() + " won!", Toast.LENGTH_SHORT)
                         .show();
    ...
    public void getPlayers() {
        ...
        String player1String = sharedPreferences.getString("user1", "");
        String player2String = sharedPreferences.getString("user2", "");
        player1 = gson.fromJson(player1String, User.class);
        player2 = gson.fromJson(player2String, User.class);
